// pages/usersManagement/UsersManagement.jsx
...
const IconUserPlus = () => (
    <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2">
        <path d="M13 7a4 4 0 11-8 0 4 4 0 018 0zM3 17a7 7 0 0110.33-6.15M16 11v6M13 14h6"
...
const IconEdit = () => (
    <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.8">
        <path d="M14.7 4.3a1 1 0 011.4 1.4l-9.9 9.9L3 16l.4-3.2 9.9-9.9z"
            strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
export default function UsersManagement() {
    ...
    const [successMsg,   setSuccessMsg]   = useState("");   // triggers SuccessModal
    ...
    const handleDelete = (user) => { if (isAdmin) setDeleteTarget(user); };

    const handleUserCreated = () => { setShowModal(false);    load(); };
    ...
    const handleUserDeleted = () => {
        ...
        load();
        setSuccessMsg(`"${deleteTarget?.fullname}" has been deleted successfully.`);
    };
                                ...
                                <td>
                                    <div className="um-actions">
                                        ...
                                        {isAdmin ? (
                                            ...
                                            <span className="um-action-btn-wrap">
                                                <button
                                                    className="um-action-btn delete"
                                                    disabled
                                                    aria-disabled="true"
                                                ...
                                                <span className="um-tooltip">Admin only</span>
                                            </span>
                                        )}
                                    </div>
                                </td>
